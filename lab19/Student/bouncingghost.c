...
int main(void) {
	...
	while(1) {
        ...
        drawRectangle(row + GHOST_HEIGHT, col, GHOST_WIDTH, 1, 0);


		//TODO: Scenario 2: ghost moves down (ie row++)
		drawRectangle(row - 1, col, GHOST_WIDTH, 1, 0);

		//TODO: Scenario 3: ghost moves left (ie col--)
        drawRectangle(row, col + GHOST_WIDTH, 1, GHOST_HEIGHT, 0);


		//TODO: Scenario 4: ghost moves right (ie col++)
		drawRectangle(row, col - 1, 1, GHOST_HEIGHT, 0);
